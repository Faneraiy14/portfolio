...
- **[NyxilumLang](https://github.com/Faneraiy14/NyxilumLang)** — сама мова: компілятор, VM, 166 вбудованих функцій (математика, рядки, HTTP + WebSocket-сервер, 2D-графіка, GUI, конкурентність, вбудована БД, керування процесами ОС, zip/regex). Ще вміє компілюватись напряму в нативний x86 (взагалі без VM) — реальні модулі власного pet-OS-ядра написані нею, скомпільовані так і завантажуються в QEMU.
